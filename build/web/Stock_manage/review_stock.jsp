...
<section class="top-bar-section">
 ...
 <div class="content">
          ...
          <div class="row">
              ...
              <h1 class="sign-title">Review Stock</h1>
              </div>
          </div>
        <br>
	...
	<form action="review_stock_val1.jsp" class="form" method="post">
                    
                    <label for="category">
	<strong>Product Category</strong>
	<input type="text" name="category" id="category"
                    accept="" placeholder="Enter the product category"
	value="" tabindex="1" required="required" />
                    </label>
                    <button class="sign-button" tabindex="2" id="submitlogin">Review Stock</button>
	</form>
                </div>
        </div>
                <div class="row">
	<div class="columns small-12 medium-7 medium-centered large-5 large-centered">
	<form action="review_stock_val2.jsp" class="form" method="post">

                    <button class="sign-button" tabindex="2" id="submitlogin">Review All Stock</button>
	</form>
                </div>
        </div>
    </body>
