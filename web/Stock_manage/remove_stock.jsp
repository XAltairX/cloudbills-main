...
<section class="top-bar-section">
 ...
 <div class="content">
          ...
          <div class="row">
              ...
              <h1 class="sign-title">Enter the product id to be removed</h1>
              </div>
          </div>
        <br>
	...
	<form action="remove_stock_val.jsp" class="form" method="post">
	...
	value="" tabindex="1" required="required" />
                    ...
                    <button class="sign-button" tabindex="2" id="submitlogin">Remove Stock</button>
	</form>
 </div>
            </div>
    </body>
